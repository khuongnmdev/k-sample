...
### 3. switchMap thay cho Subscribe lồng nhau
...
### 4. Luôn có chiến thuật catchError
...
### 5. Polling gọn gàng với timer + switchMap
...
### 6. share() khi nhiều nơi cùng lắng nghe
...
### 7. Component hiển thị - Service xử lý
